...
### 게임 플레이 방식:
양손 장비 활용: 오른손으로는 악플 몬스터를 공격하는 '정화기'를, 왼손으로는 피해자의 마음을 보호하는 '공감 배리어'를 사용하며 전략적인 플레이를 펼치기.
다양한 미션: 각 스테이지(피해자의 정신 세계)마다 다른 형태의 악플 몬스터와 보스가 등장하며, 이들의 공격 패턴을 파악하고 약점을 공략해야 함. → 스토리텔링 기반이라고 생각
퍼즐 요소: 단순히 쏘는 것을 넘어, 특정 악플 몬스터의 '논리적 허점'을 찾아 공략하는 등 퍼즐적인 요소를 가미하여 게임의 깊이를 더하기.
