...
//    public int maxEnemies = 12; // 씬에 유지할 최대 오브젝트 개수
//    public float spawnInterval = 2f; // 몇 초마다 개수를 체크하고 스폰할지
//    public int spawnNum = 1;

//    [Header("스폰 위치 설정")]
//    public float spawnDistance = 180f; // 플레이어/카메라로부터 스폰될 거리
//    public float spawnHeightRange = 100f; // 스폰될 때 추가적인 수직 위치 랜덤 범위
...
//        GameObject[] existingEnemies = GameObject.FindGameObjectsWithTag("Block");
...
//        enemiesToSpawn = maxEnemies - currentCount;
...
//    void SpawnNewEnemy(int sDtC, int cC)
//    {
//        // 스폰 위치 계산
//        float imsi = spawnDistance;
//        spawnDistance = spawnDistance + spawnDistance * 0.1f * (sDtC + cC);
